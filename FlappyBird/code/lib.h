...
public:
    ...
    static const short int TOTAL_PIPE = 20;
    static const short int PIPE_DISTANCE = 225;
    static const short int LAND_HEIGHT = 140;
    static const short int SHIBA_WIDTH = 48 * 2;
    static const short int SHIBA_HEIGHT = 34;
};